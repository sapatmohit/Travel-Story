...
const ImageSelector = ({ image, setImage, handleDeleteImg }) => {const { t } = useTranslation();
    ...
    <div>
      ...
      <button
        ...
        onClick={() => onChooseFile()}>
					...
					<p className="text-sm text-slate-500">{t("image-selector.browseImageFilesToUpload_3")}</p>
				</button> :

      <div className="w-full relative">
					<img
          src={previewUrl}
          alt={t("image-selector.selected_3")}
